        ...
        function onRequest(context) {
            if (context.request.method === 'GET') {   
                ...
                var sublist = form.addSublist({
                    ...
                    label: 'InlineEditor type sublist',
                    tab: 'tab2id'
                });

                // adding sulist list and editir 

                var sublistlist = form.addSublist({
                    id : 'sublist',
                ...
                var sublistname = form.addSublist({
                    id : 'sublistname',
                    type : serverWidget.SublistType.EDITOR,
                    label : 'Editor Type Sublist name',
                    tab: 'tab2id'
                });

                sublistlist.addField({
                    id : 'id',
                    type : serverWidget.FieldType.TEXT,
                    label : 'Internal name'
               ...
               sublistname.addField({
                id : 'countrytaxes',
                type : serverWidget.FieldType.TEXT,
                label : 'Country tax process'
              ...
              sublistname.addField({
                ...
                // var countryname = form.addField({
                //     id: 'countrynameid',
                //     type: serverWidget.FieldType.LIST,
                //     label: 'Country',
                //     container: 'tab2id'
                // });
                // var sublistnameid = form.addField({
                //     id: 'sublistnameid',
                //     type: serverWidget.FieldType.EDITOR,
                //     label: 'Sublist name',
                //     container: 'tab2id'
                // });
